...
module Alghemy
  module Modules
    # Public: Inclusion module. Aspect functionality and lookup. Extends class
    # with Clasps.
    module Aspects
      ...
      # Public: Duck for aspect calculation method. Expected of class; typically
      # Matter.
      def perceive( _asp )
